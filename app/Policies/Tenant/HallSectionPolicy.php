...
class HallSectionPolicy
{
    private const PERMISSION_BASE_NAME = 'hall-section-';
     ...
     */
    public function view(User $user, HallSection $hallSection): bool
    {
        return $user->hasPermissionTo(self::PERMISSION_BASE_NAME . 'view')
            && $this->currentTenant !== null;
    }
     ...
     */
    public function update(User $user, HallSection $hallSection): bool
    {
     ...
     */
    public function delete(User $user, HallSection $hallSection): bool
    {
