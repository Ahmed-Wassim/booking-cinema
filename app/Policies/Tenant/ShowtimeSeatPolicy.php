...
class ShowtimeSeatPolicy
{
    private const PERMISSION_BASE_NAME = 'showtime-seat-';
     ...
     */
    public function view(User $user, ShowtimeSeat $showtimeSeat): bool
    {
        return $user->hasPermissionTo(self::PERMISSION_BASE_NAME . 'view')
            && $this->currentTenant !== null;
    }
     ...
     */
    public function update(User $user, ShowtimeSeat $showtimeSeat): bool
    {
     ...
     */
    public function delete(User $user, ShowtimeSeat $showtimeSeat): bool
    {
