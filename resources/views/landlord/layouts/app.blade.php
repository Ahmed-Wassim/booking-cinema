...
<body>
    ...
    <div class="sidebar" id="sidebar">
            ...
            <ul class="nav-list">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse {{ request()->routeIs('users.*') ? 'show' : '' }}" id="usersMenu">
                        <ul class="submenu">
                            <li><a href="" class="{{ request()->routeIs('users') ? 'active' : '' }}">List Users</a>
                            </li>
                            <li><a href="" class="{{ request()->routeIs('users.create') ? 'active' : '' }}">Create User</a>
                            </li>
                        </ul>
                    </div>
                </li>
        ...
        <div class="sidebar-footer">
            <div class="user-mini d-flex align-items-center">
                <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name ?? 'User') }}&background=6366f1&color=fff&size=36"
    ...
    <div class="main-wrapper" id="mainWrapper">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end notification-dropdown shadow-lg">
                        ...
                        <div class="notification-list">
                            @include('landlord.components.notification-item', [
            ...
            @foreach (['success', 'error', 'warning'] as $msg)
                @if(session($msg))
                    <div class="alert alert-{{ $msg === 'error' ? 'danger' : $msg }} alert-dismissible fade show" role="alert">
                        @php
                            $icons = ['success' => 'check-circle-fill', 'error' => 'exclamation-circle-fill', 'warning' => 'exclamation-triangle-fill'];
                        @endphp
                        <i class="bi bi-{{ $icons[$msg] }} me-2"></i>{{ session($msg) }}
        ...
        <footer class="page-footer d-flex justify-content-between px-3 py-2">
            <span>&copy; {{ date('Y') }} {{ config('app.name', 'AdminKit') }}. All rights reserved.</span>
