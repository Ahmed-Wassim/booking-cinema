                                ...
                                <td class="text-center">
                                    @if($request->status === \App\Domain\Landlord\Enums\RegistrationRequestStatusEnum::PENDING)
                                        <div class="d-flex justify-content-center gap-2">
                                            <form action="{{ route('landlord.registration-requests.approve', $request) }}" method="POST">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-success" title="Approve & Create Tenant"
                                            ...
                                            <form action="{{ route('landlord.registration-requests.reject', $request) }}" method="POST">
                                                @csrf
